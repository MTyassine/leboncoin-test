...
use CommercialBundle\Entity\Article;
...
class ArticleController extends Controller
{
    ...
    {
        $article = new Article();
        $form = $this->createForm('CommercialBundle\Form\ArticleType', $article);
        ...
        return $this->render('CommercialBundle:article:new.html.twig', array(
            'article' => $article,
    ...
    {
        $deleteForm = $this->createDeleteForm($article);
        $editForm = $this->createForm('CommercialBundle\Form\ArticleType', $article);
        ...
        return $this->render('CommercialBundle:article:edit.html.twig', array(
            'article' => $article,
